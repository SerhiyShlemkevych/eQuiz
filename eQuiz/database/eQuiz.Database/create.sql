...
ALTER TABLE [dbo].[tblQuizPassScore] ADD CONSTRAINT [FK_tblQuizPassScore_tblQuizPass] FOREIGN KEY([QuizPassId]) REFERENCES [dbo].[tblQuizPass] ([Id]); --changed
...
ALTER TABLE [dbo].[tblUserAnswerScore] ADD  CONSTRAINT [FK_tblUserAnswerScore_tblQuizPassQuestion] FOREIGN KEY([QuizPassQuestionId]) REFERENCES [dbo].[tblQuizPassQuestion] ([Id]); --changed
...
ALTER TABLE [dbo].[tblUserTextAnswer] ADD  CONSTRAINT [FK_tblUserTextAnswer_tblQuizPassQuestion] FOREIGN KEY([QuizPassQuestionId]) REFERENCES [dbo].[tblQuizPassQuestion] ([Id]); --changed
